...
describe("Blockchain", () => {
  ...
  describe("isValidChain()", () => {
    ...
    describe("when a chain starts with a genesis block and has multiple blocks", () => {
      beforeEach(() => {
        blockchain.addBlock({ data: "Bears" });
        blockchain.addBlock({ data: "Beats" });
        blockchain.addBlock({ data: "Battle Star Galactica" });
      });
  ...
  describe("replaceChain()", () => {
    ...
    describe("when the new chain is longer", () => {
      beforeEach(() => {
        ...
        newChain.addBlock({ data: "Battle Star Galactica" });
      });
